...
- use operator tools for lab maintenance requests: raman_get_hardware_status for connection/readiness, raman_get_stage_position for read-only position checks, and raman_stage_move_relative for confirmed stage nudges
- do not construct a Raman experiment plan just to read hardware status, read stage position, or perform a stage-only nudge
